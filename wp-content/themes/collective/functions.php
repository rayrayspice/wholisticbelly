...
$stonedthemes_theme_version = "1.1.2";
	...
	function stonedthemes_fonts_url() {
		...
		if(isset($site_font['url'])){
			$font_url = add_query_arg( array(
									'family'=> esc_attr(str_replace("+"," ",$site_font["font_name"])),
...
add_filter( 'body_class', function( $classes ) {
    ...
    return array_merge( $classes, array($transparent_class,$enable_frame,$square_networks) );
} );
