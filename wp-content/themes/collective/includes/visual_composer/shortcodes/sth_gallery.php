								...
								<div class="owl-container">
									...
									if($feed=='Image Gallery'): 
										...
										foreach ( $images as $attach_id ): 
															...
															<div class="vertical-center2-container">
																<div class="vertical-center2-content">
																	<div style="display: inline-block; position: relative;">
																		<a href="">
																			<img src="'.$thumbnail1[0].'" alt="" style="max-height: 95%; width: auto; height: auto; margin: 0 auto;"/>
																		</a>
																		<a class="like">
																			<span style="">21</span>
											...
											// $output .= '<div style="height: 600px;">
											// 				<div class="vertical-center2-container">
											// 					<div class="vertical-center2-content">
											// 					<a href="">
											// 						<img src="'.$thumbnail2[0].'" alt=""/>
											// 					</a>
											// 				</div>
											// 			</div>
											// 		</div>';
													...
													$output .= '<div class="black-and-white-effect" style="text-align: center;">
																	<div class="vertical-center2-container">
																		<div class="vertical-center2-content">
																			<div style="display: inline-block; position: relative;">
																				'.$link.'
																					<img src="'.$thumb_url1[0].'" style="max-height: 95%; width: auto; height: auto; margin: 0 auto;" alt=""/>
																				</a>';
																			if($enable_likes=='Yes'):
													...
													$output .= '<div class="black-and-white-effect" style="text-align: center;">
																	<div class="vertical-center2-container">
																		<div class="vertical-center2-content">
																			<div style="display: inline-block; position: relative;">
																				'.$link.'
																					<img src="'.$thumb_url2[0].'" style="max-height: 95%; width: auto; height: auto; margin: 0 auto;" alt=""/>
																				</a>';
																			if($enable_likes=='Yes'):
