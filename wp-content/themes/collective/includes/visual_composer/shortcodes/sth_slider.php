										...
										if($slider_gallery):
											foreach ($slider_gallery as $slide) {
												...
												$output .= '<div class="royal-slider-slide">
																<img class="rsImg" src="'.esc_url($image[0]).'" alt="" data-rsTmb="'.esc_attr($image_thumb[0]).'" />
												...
												$output .= '<div class="royal-slider-slide">
																<img class="rsImg" src="'.esc_url($video_thumb_url).'" alt="" data-rsTmb="'.esc_attr($image_thumb).'" data-rsVideo="'.esc_attr($video).'" />
