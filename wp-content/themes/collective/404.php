...
<div class="fit-to-screen not-found-page">
	<div class="vertical-center2-container text-center">
		<div class="vertical-center2-content">
			...
			<?php else: ?>
				<p class="error-text"><?php esc_html__('404','collective');?></p>
				<p class="oops"><?php esc_html__('Oops','collective');?></p>
				<div class="clearfix"></div>
				<p class="error-description margin-top-lg"><?php esc_html__('The page you requested doesn\’t exist.','collective');?></p>
				<p class="error-description"><a href="<?php echo esc_url(home_url('/'));?>"><?php esc_html__('Go back to homepage','collective');?></a></p>
			<?php endif;?>
		</div>
	</div>
</div>
