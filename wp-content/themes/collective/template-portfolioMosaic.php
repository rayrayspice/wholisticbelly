...
?>	
	...
	<div class="row mosaic" id="portfolio-itmes" data-id="<?php echo esc_attr($post->ID);?>">
		...
		?>	
			<div class="<?php echo esc_attr($columns);?> <?php echo esc_attr($columns_md);?> <?php echo esc_attr($columns_sm);?> portfolio-item-container <?php echo $post_term_slugs; ?>">
						...
						<a href="<?php the_permalink(); ?>">
							<?php if(has_post_thumbnail()):?>
								...
								<span class="lazy-container" style="padding-bottom: <?php echo ($large_image_url[2] * 100) / $large_image_url[1]; ?>%; height: 0;">
									<img class="lazy" alt="&nbsp;" width="<?php echo esc_attr($large_image_url[1]);?>" src="" height="<?php echo esc_attr($large_image_url[2]);?>" data-original="<?php echo esc_url($large_image_url[0]);?>"/>
								</span>
							<?php else : ?>
