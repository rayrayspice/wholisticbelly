						...
						<a href="<?php the_permalink();?>">
							<?php if(has_post_thumbnail()):?>
								...
								<?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'stonedthemes_portfolio'); ?>
									<span class="lazy-container" style="padding-bottom: <?php echo ($large_image_url[2] * 100) / $large_image_url[1]; ?>%; height: 0;">
										<img class="lazy" alt="" width="<?php echo esc_attr($large_image_url[1]);?>" height="<?php echo esc_attr($large_image_url[2]);?>" data-original="<?php echo esc_url($large_image_url[0]);?>"/>
									</span>
								...
								<?php }elseif($image_preload=='Blur-Preload'){ ?>
									...
									<span class="blur-container" style="padding-bottom: <?php echo ($large_image_url[2] * 100) / $large_image_url[1]; ?>%; height: 0;">
										<img class="preload" alt="" src="<?php echo esc_url($small_image_url[0]);?>" data-original="<?php echo esc_url($large_image_url[0]);?>"/>
									</span>
								<?php } ?>
							<?php else : ?>
								<span style="padding-bottom: 56.25%; height: 0;">
									<img src="<?php echo esc_url(get_template_directory_uri().'/css/img/f_image.png');?>" alt=""/>
								</span>
							<?php endif; ?>	
